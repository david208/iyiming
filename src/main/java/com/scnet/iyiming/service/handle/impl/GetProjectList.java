...
public class GetProjectList implements AppHandler {
	...
	public ResponseBody handle(HttpServletRequest httpServletRequest, RequestBody requestBody) {
		...
		return projectService.getProjectList((GetProjectListReq) requestBody, httpServletRequest.getContextPath(), id);
	}
